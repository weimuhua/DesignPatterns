...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        /** 组合模式，工作中较常见，比较熟悉，不具体实现并测试 */

        /** 适配器模式, 工作中较常见, 比较熟悉, 不具体实现并测试 */

        /** 包装模式, 工作中较常见, 比较熟悉, 不具体实现并测试 */

        /** 享元模式(如线程池), 工作中较常见, 比较熟悉, 不具体实现并测试 */

        /** 外观模式, 工作中较常见, 比较熟悉, 不具体实现并测试 */

        /** 桥接模式, 工作中不常见, 不具体实现并测试 */
    }
